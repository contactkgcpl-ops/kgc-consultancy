...
export function FoodConsultingPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
        ...
        <div className="container-xl px-4 md:px-8 mx-auto relative z-10">
          <div className="w-full max-w-5xl">
            ...
            <p className="text-gray-600 text-[13px] md:text-[14px] leading-relaxed mb-8 max-w-3xl font-medium">
              Partner with <span className="font-bold text-black">KGC Consultancy</span>, the leading food product consultant in India. We offer expert formulation services for food startups and manufacturers.<br className="hidden md:block"/><br className="hidden md:block"/>
              <span className="font-bold text-black">KGC Consultancy</span> is India's most reliable food consulting company. Our team of expert food scientists supports your idea development, perfects your recipes, and makes your product scalable and market-ready through practical, industry-based strategies.
            </p>
            
            <div className="flex flex-wrap gap-2.5 mb-10 max-w-4xl">
              {[
                "Recipe Formulation", "Shelf-Life Extension", "Process Optimization", 
                "Scale-up", "Cost Reduction", "FSSAI Compliance"
              ].map((item, idx) => (
      ...
      <section className="w-full border-t border-b border-gray-100 bg-[#f4f4f4]">
        <img src={foodHero} alt="KGC Food Consulting Lab" className="w-full h-auto block" />
      </section>
            ...
            {[
              {
                ...
                desc: <>Customised <span className="text-red-400 font-medium">recipe formulation</span> for unique taste profiles.</>
              },
              {
                num: "02",
                img: "/src/assets/images/services/service_2.png",
                title: "Commercial Scale-up",
                desc: <>Expert <span className="font-bold text-black">food consultant support</span> to scale up your recipe.</>
              },
              {
                num: "03",
                img: "/src/assets/images/services/service_3.png",
                title: "Process Optimization",
                desc: <>Efficient, scalable processes for <span className="text-red-400 font-medium">FMCG brands.</span></>
              },
              {
                num: "04",
                img: "/src/assets/images/services/service_4.png",
                title: "FSSAI Compliance",
                desc: <>Regulatory support ensuring <span className="text-red-400 font-medium">FSSAI</span> compliance</>
              },
              {
                num: "05",
                img: "/src/assets/images/services/service_5.png",
                title: "Nutritional Analysis",
                desc: <>Our <span className="font-bold text-black">consultant expertise</span> for accurate macro and micro analysis.</>
              },
              {
                num: "06",
                img: "/src/assets/images/services/service_6.png",
                title: "Shelf-Life Extension",
                desc: <>Develop products with expert formulation for maximum flavor and shelf life.</>
              }
            ].map((service, idx) => (
