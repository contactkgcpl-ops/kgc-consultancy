...
import snacksHero from '../../assets/images/snacks_hero.jpg';

export function SnacksConfectioneryPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
        ...
        <div className="container-xl px-4 md:px-8 mx-auto relative z-10">
          <div className="w-full max-w-5xl">
            ...
            <h1 className="text-[36px] md:text-[48px] lg:text-[56px] font-medium text-black leading-[1.1] mb-3 italic tracking-tight">
              Snacks & Confectionery Consultant
            </h1>
            
            <h2 className="text-[18px] md:text-[22px] text-black font-medium mb-6">
              for Startups & FMCG Brands
            </h2>
            
            <p className="text-gray-600 text-[13px] md:text-[14px] leading-relaxed mb-8 max-w-3xl font-medium">
              Partner with <span className="font-bold text-black">KGC Consultancy</span>, the leading snacks and confectionery consultant in India. We offer expert formulation services for baked goods, chocolates, and healthy snacks.<br className="hidden md:block"/><br className="hidden md:block"/>
              <span className="font-bold text-black">KGC Consultancy</span> is India's most reliable snacks consulting company. Our team of expert food scientists supports your idea development, perfects your recipes, and makes your product scalable and market-ready through practical, industry-based strategies.
            </p>
            
            <div className="flex flex-wrap gap-2.5 mb-10 max-w-4xl">
              {[
                "Healthy Snacks", "Makhana Blends", "Energy Bars", 
                "Baked Goods", "Chocolates", "Candies & Gummies"
              ].map((item, idx) => (
      ...
      <section className="w-full border-t border-b border-gray-100 bg-[#f4f4f4]">
        <img src={snacksHero} alt="KGC Snacks Consulting Lab" className="w-full h-auto block" />
      </section>
        ...
        <div className="container-xl px-4 md:px-8 mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                num: "01",
                img: "/src/assets/images/services/snack_service_1.jpg",
                title: "Custom Confectionery Formulation",
                desc: <>Customised <span className="text-red-400 font-medium">confectionery formulation</span> for targeted taste benefits.</>
              },
              {
                num: "02",
                img: "/src/assets/images/services/snack_service_2.jpg",
                title: "Healthy Snacks Consultant",
                desc: <>Expert <span className="font-bold text-black">snack consultant support</span> to create delicious, healthy, and marketable snacks.</>
              },
              {
                num: "03",
                img: "/src/assets/images/services/snack_service_3.jpg",
                title: "Makhana Recipe Formulation",
                desc: <>Delicious, textured, and scalable makhana recipes for <span className="text-red-400 font-medium">Makhana brands.</span></>
              },
              {
                num: "04",
                img: "/src/assets/images/services/snack_service_4.jpg",
                title: "Extruded Snacks & Kurkure Formulation",
                desc: <>Nutritious and bold-flavored extruded snack recipes with a balance of taste and shelf life, ensuring <span className="text-red-400 font-medium">FSSAI</span> compliance</>
              },
              {
                num: "05",
                img: "/src/assets/images/services/snack_service_5.jpg",
                title: "Diet & Multigrain Snacks Formulation",
                desc: <>Our <span className="font-bold text-black">consultant expertise</span> for balanced formulation of protein puffs and multigrain crisps.</>
              },
              {
                num: "06",
                img: "/src/assets/images/services/snack_service_6.jpg",
                title: "Snacks Packaging & Shelf-Life",
                desc: <>Develop <span className="text-red-400 font-medium">premium packaged snacks</span> with expert formulation for maximum flavor and shelf life.</>
              }
            ].map((service, idx) => (
