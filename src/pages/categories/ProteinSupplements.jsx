...
import proteinHero from '../../assets/images/protein_hero.jpg';

export function ProteinSupplementsPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
        ...
        <div className="container-xl px-4 md:px-8 mx-auto relative z-10">
          <div className="w-full max-w-5xl">
            ...
            <h1 className="text-[36px] md:text-[48px] lg:text-[56px] font-medium text-black leading-[1.1] mb-3 italic tracking-tight">
              Protein & Supplements Consultant
            </h1>
            
            <h2 className="text-[18px] md:text-[22px] text-black font-medium mb-6">
              for Startups & Fitness Brands
            </h2>
            
            <p className="text-gray-600 text-[13px] md:text-[14px] leading-relaxed mb-8 max-w-3xl font-medium">
              Partner with <span className="font-bold text-black">KGC Consultancy</span>, the leading nutraceutical and supplements consultant in India. We offer expert formulation services for sports nutrition startups and manufacturers.<br className="hidden md:block"/><br className="hidden md:block"/>
              <span className="font-bold text-black">KGC Consultancy</span> is India's most reliable supplements consulting company. Our team of expert consultants supports your idea development, perfects your blends, and makes your product scalable and market-ready through practical, industry-based strategies.
            </p>
            
            <div className="flex flex-wrap gap-2.5 mb-10 max-w-4xl">
              {[
                "Whey Protein", "Vegan Supplements", "Mass Gainers", 
                "Pre-workouts", "BCAA", "Vitamins & Minerals"
              ].map((item, idx) => (
      ...
      <section className="w-full border-t border-b border-gray-100 bg-[#f4f4f4]">
        <img src={proteinHero} alt="KGC Supplements Consulting Lab" className="w-full h-auto block" />
      </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
            <div>
              ...
              <h2 className="text-[32px] md:text-[40px] italic text-black font-medium leading-[1.1] tracking-tight">
                Supplement Product Development<br/>
            ...
            {[
              {
                ...
                title: "Custom Protein Formulation",
                desc: <>Customised <span className="text-red-400 font-medium">protein formulation</span> (Whey/Vegan) for targeted athletic health benefits.</>
              },
              {
                num: "02",
                img: "/src/assets/images/services/protein_service_2.jpg",
                title: "Pre-Workout Consultant",
                desc: <>Expert <span className="font-bold text-black">supplement consultant support</span> to create effective, energized, and marketable blends.</>
              },
              {
                num: "03",
                img: "/src/assets/images/services/protein_service_3.jpg",
                title: "Mass Gainer Formulation",
                desc: <>Delicious, textured, and scalable gainer recipes for <span className="text-red-400 font-medium">Fitness brands.</span></>
              },
              {
                num: "04",
                img: "/src/assets/images/services/protein_service_4.jpg",
                title: "Vitamin & Mineral Mixes",
                desc: <>Nutritious supplement recipes with a balance of taste and solubility, ensuring <span className="text-red-400 font-medium">FSSAI</span> compliance</>
              },
              {
                num: "05",
                img: "/src/assets/images/services/protein_service_5.jpg",
                title: "Functional Supplement Formulation",
                desc: <>Our <span className="font-bold text-black">consultant expertise</span> for balanced formulation and development.</>
              },
              {
                num: "06",
                img: "/src/assets/images/services/protein_service_6.jpg",
                title: "Flavor Profiling",
                desc: <>Develop <span className="text-red-400 font-medium">premium flavors</span> with expert formulation to mask bitter supplement ingredients.</>
              }
            ].map((service, idx) => (
